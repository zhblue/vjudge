...
<div style="text-align:center;margin-top:30px;clear:both;font-size:80%">
	<hr />FAQ | About Virtual Judge | <a href="https://groups.google.com/group/virtual-judge" target="_blank">Forum</a> | <a href="${contextPath}/discuss.action" target="_blank">Discuss</a> | <a href="https://github.com/zhblue/vjudge" target="_blank">Open Source Project</a><br />
	All Copyright Reserved ©2010-2014 <a href="http://github.com/zhblue/hustoj">HUSTOJ OpenSource</a> TEAM
